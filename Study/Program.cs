        ...
        public static async Task Main(string[] args)
        {
            ...
            while(true)
            {
                try
                {
                    ...
                    {
                        Console.WriteLine($"O valor do ativo {asset} é inferior ao valor de compra determinado. Enviando E-Mail ao cliente");
                    ...
                    {
                        Console.WriteLine($"O valor do ativo {asset} é superior ao valor de venda determinado. Enviando E-Mail ao cliente");
